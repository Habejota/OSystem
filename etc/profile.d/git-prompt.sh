...
then
	...
	PS1='\[\033]0;\h:$PWD\007\]' # set window titleif test -z "$WINELOADERNOEXEC"
...
alias pip="/sample/IronPython/Scripts/pip.exe"alias tardisproject="/etc/profile.d/tardisproject.exe"