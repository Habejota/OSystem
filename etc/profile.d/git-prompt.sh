...
alias kbl="/bin/kb list"
alias kbe="/bin/kb edit"
alias kba="/bin/kb add"
alias kbv="/bin/kb view"
alias kbd="/bin/kb delete --id"
alias kbg="/bin/kb grep"
alias kbt="/bin/kb list --tags"
alias kb="/bin/kb.exe"
alias codec="git status"
